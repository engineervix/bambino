  ...
  <v-form ref="form" @submit.prevent="handleSubmit">
    ...
    <v-card variant="outlined" class="mb-4">
      <v-card-text>
        ...
        <v-row>
          <v-col cols="6">
            <v-checkbox v-model="formData.wet" label="Wet" color="primary" hide-details />
          </v-col>
          <v-col cols="6">
            <v-checkbox v-model="formData.dirty" label="Dirty" color="primary" hide-details />
          </v-col>
        </v-row>
