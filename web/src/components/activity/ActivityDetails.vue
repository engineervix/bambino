  ...
  <div class="activity-details">
    ...
    <div v-if="activity.type === 'feed' && activity.feed_data">
      <div class="d-flex align-center mb-1">
        ...
        <span v-if="activity.feed_data.amount_ml" class="text-body-2">
          {{ activity.feed_data.amount_ml }}ml
        </span>
    ...
    <div v-else-if="activity.type === 'pump' && activity.pump_data">
      <div class="d-flex align-center mb-1">
        ...
        <span v-if="activity.pump_data.amount_ml" class="text-body-2">
          {{ activity.pump_data.amount_ml }}ml
        </span>
    ...
    <div v-else-if="activity.type === 'diaper' && activity.diaper_data">
      <div class="d-flex align-center mb-1">
        ...
        <v-chip 
          v-if="activity.diaper_data.dirty" 
          size="small" 
          color="brown" 
          class="mr-1"
        >
      ...
      <div v-if="detailed && (activity.diaper_data.color || activity.diaper_data.consistency)" class="text-caption text-grey">
    ...
    <div v-else-if="activity.type === 'sleep' && activity.sleep_data">
      ...
      <div class="text-caption text-grey">
        ...
        <span v-else class="text-success">
          Currently sleeping • {{ formatTimeAgo(activity.start_time) }}
        </span>
      </div>
    </div>
    ...
    <div v-else-if="activity.type === 'health' && activity.health_data">
      <div class="d-flex align-center mb-1">
        <v-chip 
          size="small" 
          :color="getHealthTypeColor(activity.health_data.record_type)" 
          class="mr-2"
        >
    ...
    <div v-if="detailed" class="mt-3 pt-2 border-t">
      <div class="text-caption text-grey">
        ...
        <div v-if="activity.end_time">
          Ended: {{ formatDetailedTime(activity.end_time) }}
        </div>
